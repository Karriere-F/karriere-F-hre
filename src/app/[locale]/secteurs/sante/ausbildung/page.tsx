...
import { AUSBILDUNG_METIERS, SANTE_FICHES, SANTE_UI, tr } from "@/lib/sante-metiers";
...
export default async function SanteAusbildungPage() {
  ...
  return (
    <div>
      ...
      <PageHero title={tr(SANTE_UI.hubTitle, locale)} subtitle={tr(SECTEURS_UI.routeAusbildungIntro, locale)} />
